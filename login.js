document.addEventListener("DOMContentLoaded", function () {
  ...
  userLoginForm.addEventListener("submit", async function (event) {
      ...
      userEmailError.textContent = validateEmail(email) ? "" : "Invalid email format";
      userPasswordError.textContent = validatePassword(password) ? "" : "Password must be at least 8 characters long";
